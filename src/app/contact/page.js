        ...
        >
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-sm">
              NAME:
              <span className="text-red-400">Femi Theophilus</span>
            </h1>
          </div>
          ...
          <p>
            <a
              ...
              href="mailto:belovedtheophilus15@gmail.com"
              data-testid="belovedtheophilus15@gmail.com"
              target="-blank"
            >
              belovedtheophilus15@gmail.com
            </a>
          </p>
